...
<div class="group">
    ...
    <div id="companySection" class="{{ (isset($user->roles[0])) ? ($user->roles[0] == 'exhibitor') ? '' : 'hidden' : 'hidden'}}" >
        <div class="group">
            ...
            <div id="company" class="select hidden" style="width: 250px;">
                <select name="company" autocomplete="off" disabled>
    ...
    <div id="testScheduleSection" class="{{ (isset($user->roles[0])) ? ($user->roles[0] == 'visitor') ? '' : 'hidden' : 'hidden' }}" >
      <div class="group">
        <label for="testSchedule">Billet</label>
            <div id="testSchedule" class="select" style="width: 250px;" disabled>
        <select name="testSchedule" autocomplete="off" disabled>
